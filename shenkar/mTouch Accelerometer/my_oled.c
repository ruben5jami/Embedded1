...
void FillPage(unsigned char data, unsigned char page)
{
	unsigned char j;
		WriteCommand(page);		// Set page
		for(j=0;j<120;j++)			// Write to all 132 bytes
		{
			WriteData(data);
		}
		return;
...
ROM BYTE g_pucFont[95][5] =
{
    ...
    { 0x10, 0x10, 0x10, 0x10, 0x10 }, // #   0x23	//line
    { 0x10, 0x10, 0x08, 0x08, 0x10 }, // $   0x24	//line up
    { 0x00, 0x00, 0xff, 0x00, 0x00 }, // %   0x25	//vertical line
    { 0x18, 0x18, 0xe7, 0x00, 0x00 }, // &   0x26	//vertical up line
    { 0x00, 0x05, 0x03, 0x00, 0x00 }, // '   0x27	
    { 0x60, 0x20, 0x20, 0x20, 0x60 }, // (   0x28	//up parentasise
    { 0x03, 0x02, 0x02, 0x02, 0x03 }, // )   0x29	//down parentasise
    ...
    { 0x20, 0x40, 0xff, 0x40, 0x20 }, // ?   0x3F	//down
    ...
    { 0x3c, 0x3c, 0x3c, 0x3c, 0x3c }, // ^   0X5E	square
    { 0x04, 0x02, 0xff, 0x02, 0x04 }, // _   0X5F	up
    { 0x10, 0x18, 0x27, 0x18, 0x10 }, // `   0X60	rewriting
    ...
    { 0x90, 0x90, 0x9f, 0x90, 0x90 }, // {   0X7B	//on
    { 0x00, 0x00, 0x7f, 0x00, 0x00 }, // |   0X7C	
    { 0xc0, 0xc0, 0xff, 0xc0, 0xc0 }, // }   0X7D	//off
    { 0x00, 0x00, 0x06, 0x09, 0x06 }, // ~   0X7E	//degrees
};